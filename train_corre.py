...
def main(args):
    ...
    #load parameters from pretrained_model
    
    '''
    model_dict = {}
    state_dict = model.state_dict()
    #pretrain_dict = torch.load('/home/pengqy/paper/resnet50_baseline_0/PETA/PETA/img_model/ckpt_max.pth')['state_dicts']
    pretrain_dict = torch.load('/home/pengqy/paper/resnet50_corre_2/PETA/PETA/img_model/ckpt_max.pth')['state_dicts']
    for k, v in pretrain_dict.items():
        ...
        if k in state_dict:
            ...
            #elif k.startswith('module.classifier.logits.0'):
                #pdb.set_trace()
                #model_dict[k] = v
            #elif k.startswith('module.classifier.logits_corre'):
                #pdb.set_trace()
                #model_dict[k] = v
    ...
    #    print(k)
    #pdb.set_trace()
    #print(model.state_dict()['module.classifier.logits_corre.0.weight'])
    '''
    ...
    '''
    param_groups = [{'params': filter(lambda p: p.requires_grad, model.module.finetune_params()), 'lr': 0.01},
