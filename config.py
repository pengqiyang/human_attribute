...
def argument_parser():
    ...
    parser.add_argument("--train_split", type=str, default="train", required=True, choices=['train', 'test','trainval'])
    parser.add_argument("--model_name", type=str, default="resnet50")
    parser.add_argument("--valid_split", type=str, default="val", required=True, choices=['test', 'val', 'train', 'trainval'])
