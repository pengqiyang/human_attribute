...
from batch_engine2 import valid_trainer, batch_trainer
...
def main(args):
    ...
    optimizer = torch.optim.SGD(model.parameters(), lr=args.lr_ft, momentum=args.momentum, weight_decay=args.weight_decay, nesterov=False)
