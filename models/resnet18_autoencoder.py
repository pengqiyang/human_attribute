...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        output_0= self.layer4(layer3)
         
              
        layer4 = self.layer4_1x1(output_0)
...
def resnet18_autoencoder(pretrained=False, progress=True, **kwargs):
