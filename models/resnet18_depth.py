...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.att_layer1 = nn.Sequential(
            ...
            nn.MaxPool2d(kernel_size=(4, 4), stride=(4, 4), dilation=(1, 1), ceil_mode=False),
    ...
    def forward(self, x, depth):
        ...
        x = self.layer2((x+att1))
     
        x = self.layer3((x+att2))

     
        x = self.layer4((x+att3))
...
def resnet18_depth(pretrained=False, progress=True, **kwargs):
