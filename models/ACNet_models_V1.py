...
class ACNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.atten_rgb_1 = self.channel_attention(64)
        self.atten_depth_1 = self.channel_attention(64)
        # self.conv_2 = nn.Conv2d(64*4, 64*4, kernel_size=1) #todo 用cat和conv降回通道数
        self.atten_rgb_2 = self.channel_attention(128)
        self.atten_depth_2 = self.channel_attention(128)
        self.atten_rgb_3 = self.channel_attention(256)
        self.atten_depth_3 = self.channel_attention(256)
        self.atten_rgb_4 = self.channel_attention(512)
        self.atten_depth_4 = self.channel_attention(512)
    ...
    def forward(self, rgb, depth, phase_checkpoint=False):
        ...
        return  m4  # channel of m is 2048
