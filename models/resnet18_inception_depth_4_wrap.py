...
__all__ = ['resnet18_inception_depth_4_wrap']
att = 0
model_urls = {
...
class depth_branch(nn.Module):
    ...
    def forward(self, depth):
        ...
        output_1 = self.att_d_layer3(depth) 
        ...
        output_2 = self.att_d_layer4(depth)         
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.depth_network = depth_branch()
    ...
    def forward(self, x, depth):
        ...
        output_1, output_2 = self.depth_network(depth)
        ...
        x = output_1 + self.att_rgb_layer3(x) #merge
       
        x = self.layer4(x)
       
        x = output_2 + self.att_rgb_layer4(x) #merge   
...
def resnet18_inception_depth_4_wrap(pretrained=False, progress=True, **kwargs):
