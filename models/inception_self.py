...
class ResNet(nn.Module):
    ...
    def forward(self, depth):
        ...
        depth = torch.cat([inception_3a_relu_1x1_out,inception_3a_relu_3x3_out,inception_3a_relu_double_3x3_2_out ,inception_3a_relu_pool_proj_out], 1)
...
def inception_self(pretrained=False, progress=True, **kwargs):
